    ...
    <section class="achievement-section">
        <div class="achievement-item">
            ...
            <div class="achievement-supplement">
                <div class="achievement-Polychrome">
                    <img :src="achievementStore.PolychromeImg" alt="菲林">
                    <div class="achievement-PolychromeNum">
                        {{ info.PolychromeNum }}
                    </div>
                </div>
            ...
            <div class="achievement-content">
                ...
                <div class="achievement-desc"  v-html="info.Desc"></div>
            </div>
        </div>
    </section> 
</template>
...
.achievement-Polychrome{
    width: 45px;
    height: 45px;
    /* min-width: 45px; */
    /* border: 1px solid #00A8E8; */
    background-color: var(--liyin-ach-polychrome-bg-color);
    border-radius: 5px;
    display: flex;
    flex-direction: column;
    justify-content: center;
...
.achievement-PolychromeNum{
    width: 100%;
    text-align: center;
    font-size: 12px;
    /* font-weight: 800; */
    /* margin: 0 0 0 10px; */
    color: var(--liyin-ach-polychrome-num-text-color);
    position: absolute;
    bottom: 0;
    z-index: 2;
}
.achievement-PolychromeNum::before{
    content: '';
    width: 100%;
    height: 100%;
    background-color: var(--liyin-ach-polychrome-num-bg-color);
    opacity: 0.6;
    position: absolute;
    bottom: 0;
    left: 0;
