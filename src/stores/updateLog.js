    ...
    const updateLogInfo = [
        {
            ...
            date: '2026-07-30', 
            title: '调整3.1版本多选一成就',
            changes: '<ul><li>调整3.1版本多选一成就</li></ul>' 
        },
        {
            version: '3.1.0', 
            date: '2026-07-30', 
            title: '新增3.1版本成就',
            changes: '<ul><li>新增3.1版本成就</li></ul>' 
        },
        {
            version: '3.0.1', 
            date: '2026-06-18', 
        ...
        },
        {
            ...
            date: '2026-06-17', 
            title: '新增3.0版本成就',
            changes: '<ul><li>新增3.0版本成就</li></ul>' 
        },
        {
            version: '2.8.0', 
            date: '2026-05-06', 
            title: '新增2.8版本成就',
            changes: '<ul><li>新增2.8版本成就</li></ul>' 
        },
        {
            version: '2.7.0', 
            date: '2026-03-24', 
            title: '新增2.7版本成就',
            changes: '<ul><li>新增2.7版本成就</li></ul>' 
        },
        {
            version: '2.6.1', 
            date: '2026-02-08', 
            title: '修正2.6版本多选一成就',
            changes: '<ul><li>修正2.6版本多选一成就</li></ul>' 
        },
        {
            version: '2.6.0', 
            date: '2026-02-07', 
            title: '新增2.6版本成就，新增2.6版本角色',
            changes: '<ul><li>新增2.6版本成就</li><li>新增2.6版本角色</li></ul>' 
        },
        {
            version: '2.5.1', 
            date: '2025-12-31', 
            title: '调整第一分类展示排序与游戏内一致',
            changes: '<ul><li>调整第一分类展示排序与游戏内一致</li></ul>' 
        },
        {
            version: '2.5.0', 
            date: '2025-12-30', 
            title: '新增2.5版本成就，新增2.5版本角色',
            changes: '<ul><li>新增2.5版本成就</li><li>新增2.5版本角色</li></ul>' 
        },
        {
            version: '2.4.0', 
            date: '2025-11-27', 
            title: '新增2.4版本成就，新增2.4版本角色',
            changes: '<ul><li>新增2.4版本成就</li><li>新增2.4版本角色</li></ul>' 
        },
        {
            version: '2.3.0', 
            date: '2025-10-15', 
            title: '新增2.3版本成就，新增2.3版本角色',
            changes: '<ul><li>新增2.3版本成就</li><li>新增2.3版本角色</li></ul>' 
        },
        {
            version: '2.2.0', 
            date: '2025-09-04', 
